...
const MobileSearch = ({ value, setValue, popupState }) => {
    ...
    const handleSearch = () => {
        if (value.length > 0 || value.length === 42) {
            ...
            EventBus.dispatch('call-api', { address: value, chain: chainId });
            setValue('');
        }
    };
        ...
        <OutlineInputStyle
            ...
            endAdornment={
                <InputAdornment position="end">
                    <ButtonBase sx={{ borderRadius: '12px' }} disabled={value.length < 1 || value.length !== 42}>
                        <HeaderAvatarStyle variant="rounded">
                            <IconAdjustmentsHorizontal stroke={1.5} size="1.3rem" onClick={handleSearch} />
                        </HeaderAvatarStyle>
                    </ButtonBase>
                    <Box sx={{ ml: 2 }}>
        ...
        <>
            ...
            <Box sx={{ display: { xs: 'none', md: 'block' } }}>
                <OutlineInputStyle
                    ...
                    endAdornment={
                        <InputAdornment position="end" disabled={value.length < 1 && value.length !== 42}>
                            <ButtonBase sx={{ borderRadius: '12px' }}>
                                <HeaderAvatarStyle variant="rounded">
                                    <IconAdjustmentsHorizontal stroke={1.5} size="1.3rem" onClick={handleSearch} />
                                </HeaderAvatarStyle>
